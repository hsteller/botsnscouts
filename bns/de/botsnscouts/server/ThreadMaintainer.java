...
/**
 * The admin-functions on the entity that maintains the list of active ServerRobotThreads / ServerOutputThreads
 */
public interface ThreadMaintainer {
    /**
     * Should give a reference, as any non-alive threads will be removed by an Iterator.remove()
     */
    java.util.Vector<ServerAusgabeThread> /* of ServerAusgabeThread */getActiveOutputs();
