...
public class ServerAntwort {
    ...
    /**
     * zu Debug-/Informationszwecken: Die Methode liefert den Namen der
     * ServerAntwort-Konstanten (mit Wert t) als String zur�ck.
     */
    public String getTyp() {
        switch (this.typ) {
            case PROGRAMMIERUNG:
                return "PROGRAMMIERUNG (TRP)";
            case AUSRICHTUNG:
                return "AUSRICHTUNG (TNR)";
            case REAKTIVIERUNG:
                return "REAKTIVIERUNG (TBD)";
            case REPARATUR:
                return "REPARATUR (TRR)";
            case ABMELDUNG:
                return "ABMELDUNG (RLE)";
            case AENDERUNGFERTIG:
                return "AENDERUNGFERTIG (OK)";
            case GIBSPIELFELDDIM:
                return "GIBSPIELFELDDIM (GSD)";
            case GIBSPIELFELD:
                return "GIBSPIELFELD (GPL)";
            case GIBFAHNENPOS:
                return "GIBFAHNENPOS (GFL)";
            case GIBNAMEN:
                return "GIBNAMEN (GSN)";
            case GIBROBOTERPOS:
                return "GIBROBOTERPOS (SRO)";
            case GIBFELDINHALT:
                return "GIBFELDINHALT (SFI)";
            case GIBROBSTATUS:
                return "GIBROBSTATUS (GRS)";
            case GIBSPIELSTAND:
                return "GIBSPIELSTAND (GSS)";
            case GIBAUSWERTUNGSSTATUS:
                return "GIBAUSWERTUNGSSTATUS (GSA)";
            case GIBTIMEOUT:
                return "GIBTIMEOUT (GTO)";
            case GIBFARBEN:
                return "GIBFARBEN (GSF)";
            case MESSAGE:
                return "MESSAGE (MSG)";
            case STATS:
                return "STATS (GST)";
            case MSG_ACK:
                return "MSG_ACK (MOK)";
            case IS_SCOUT_ALLOWED:
                return "IS SCOUT ALLOWED (ISS)";
            case IS_WISENHEIMER_ALLOWED:
                return "IS WISENHEIMER ALLOWED (ISW)";
            case CAN_PUSHERS_PUSH_MORE_THAN_ONE_BOT:
                return "CAN_PUSHERS_PUSH_MORE_THAN_ONE_BOT (ISPPMB)";
            default:
                return "ERROR - UNKNOWN KIND OF COMMUNICATION";
