...
*/
   public void aenderung (String [] roboternamen)  throws KommException {
	 ...
	 if (CAT.isDebugEnabled())
	     CAT.debug("Message send: "+id+" "+name1+" "+name2+" "+name3+" "+name4); 
     } 
