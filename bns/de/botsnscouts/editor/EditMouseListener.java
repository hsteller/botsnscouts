                                ...
                                if (editor.indx == 60) {// vert wand
                                    ...
                                    if (editor.indx == 61) {// horiz. wand
                                        ...
                                        if (editor.indx == 62) {// laser nach
                                            ...
                                            if (editor.indx == 63) {// laser
                                                                    // nach sued
                                                new StrengthDialog(editor, Message.say("BoardEditor", "mLaser"), true);
                                                editor.board.setSouthLaser(editor.spfX, 12 - editor.spfY,
                                                                editor.laserSt);
                                            }
                                            else
                                                if (editor.indx == 64) {// laser
                                                                        // nach
                                                                        // ost
                                                    new StrengthDialog(editor, Message.say("BoardEditor", "mLaser"),
                                                                    true);
                                                    editor.board.setEastLaser(editor.spfX, 11 - editor.spfY,
                                                                    editor.laserSt);
                                                }
                                                else
                                                    if (editor.indx == 65) {// laser
                                                                            // nach
                                                                            // nord
                                                        new StrengthDialog(editor,
                                                                        Message.say("BoardEditor", "mLaser"), true);
                                                        editor.board.setNorthLaser(editor.spfX, 11 - editor.spfY,
                                                                        editor.laserSt);
                                                    }
                                                    else { // fliessband etc.
                                                        editor.board.setFloor(editor.spfX + 1, 12 - editor.spfY,
                                                                        editor.elemTyp[editor.indx],
                                                                        editor.elemSpez[editor.indx]);
