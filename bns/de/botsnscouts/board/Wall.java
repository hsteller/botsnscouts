...
public class Wall {
    ...
    private static HashMap<String, Wall> cache = new HashMap<String, Wall>();

    public static Wall getWall(String wallString) throws FormatException {
        Wall w = cache.get(wallString);
        if (w == null) {
    ...
    private static Wall parseWall(String wallString) throws FormatException {
        ...
        if (ParseUtils.is(wallString, strpos, '#')) {
            ...
            if (ParseUtils.is(wallString, strpos, '_')) {
                neu.da = false;
                return neu;
            }
            else
                if (ParseUtils.is(wallString, strpos, '[')) {
                    ...
                    if (ParseUtils.is(wallString, strpos, 'L')) {
                        ...
                        if (ParseUtils.is(wallString, strpos, 'S')) {
                    ...
                    throw new FormatException(Message.say("Board", "xCharsNotFound", "#_[", strpos,
                                    "" + wallString.charAt(strpos)));
                }
