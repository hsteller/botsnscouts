...
/**
 * Panel for choosing options while joining a game, incl. querying the metaserver about currently available games.
 * 
...
public class JoinGamePanel extends ColoredComponent {
    ...
    private JTextField hostName = new TJTextField(Message.say("Start", "mServerInh"), SwingConstants.CENTER, true);
    ...
    private JList<String> favServerList;

    private JList<String> announcedGamesList = new JList<String>();
    ...
    private Vector<String> favServers;
    ...
    public JoinGamePanel(Start par) {
        ...
        OkComponent confirmPanel = new OkComponent(Message.say("Start", "mGoButton"), Message.say("Start",
                        "mZurueckButton"));
    ...
    private JComponent createFindServersView() {
        ...
        favServerList = new JList<String>(favServers);
        ...
        favServerList.addListSelectionListener(new ListSelectionListener() {
            public void valueChanged(ListSelectionEvent event) {
                hostName.setText(favServerList.getSelectedValue());
            }
