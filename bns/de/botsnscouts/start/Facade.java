...
/**
 * Diese Klasse dient der Entkopplung der GUI-Schicht (StartSpieler) von der Fachkonzeptschicht(...) und der Datenhaltungsschicht (...)
 * 
 * @version $Id$
 */
...
public class Facade {
    ...
    private static final Category CAT = Category.getInstance(Facade.class);
     ...
     * 
     * @param spfProp
     *            a Properties-object generated by getBoardAsProperties, above.
     */
    ...
    public static BNSThread participateInAGame(String ip, int port, String name, int color)
                    throws JoiningGameFailedException {
        return Launcher.participateInAGame(ip, port, name, color, false);
    }

    /*
     * public static BNSThread participateInAGame(String ip, String name, int color) { return Launcher.participateInAGame(ip, GameOptions.DPORT, name,
     * color, false); }
     */
    ...
    public void gameStarts() {
        // TODO I'll keep the tiles as I haven't figured out a nice way to reload
    ...
    /**
     * After everything is chosen, update the game options, i.e. set field and flags.
     */
