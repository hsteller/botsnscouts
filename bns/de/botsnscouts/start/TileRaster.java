...
public class TileRaster{
    ...
    //setzt �bergebene Tile an Stelle (x,y)
    ...
    //pr�ft ob auf der Tile at (x,y) Flaggen stehen
    ...
    //gibt Tiles als 2-dim Array von Board zur�ck
    ...
    //pr�ft ob Board g�ltig ist (plausibilit�tstests)
    ...
    //markiert alle (mit der ersten) zusammenh�ngende Tiles
