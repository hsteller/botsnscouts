...
public class CLIStarter {
  ...
  /** Prints a little help text to create spf-Files.
   *  May cause a System.exit(0)
   */
  ...
  /** Here the value of <code>spfFilePath</code> will be set.
   *  It is checked that the file at <code>spfFilePath</code> exists
   *  and is readable.
   */
  ...
  /** We ask for the number of autobots and how sophisticated each of them
   *  will play.
   */
