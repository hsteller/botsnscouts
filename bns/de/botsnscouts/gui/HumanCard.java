...
/**
 * extends the Card object with state of the card like: LOCKED, FREE, FILLED
 * 
...
public class HumanCard extends Card {
    ...
    // /** returns the compare */
    // // ENNO:nobody (except equals) ever used this, so I redefined it to do
    // s.th. sensible, see below
    // public int compareTo(Object c) {
    // if ((this.getaktion() == ((Card) c).getaktion()) && ((this.getprio() ==
    // ((Card) c).getprio() ) ) ) {
    // return 0;
    // }
    // else {
