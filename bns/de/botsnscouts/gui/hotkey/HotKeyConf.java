...
/**
 * Defines lots of constants that are important for hotkey management and also
 * for displaying them in the HotKeyEditorPanel.
 */
public class HotKeyConf {
    // To add a hotkey:
    // (1) add a constant with its name (see below: declaration of
    // HOTKEY_something)
    // (2) add that constant to one of the group arrays below (probably
    // GROUP_NORMAL)
    // (3) add a description for your hotkey to the HotKeyDescription section in
    // the
    // MessagesBundle files in botsnscouts.conf, using the value of your
    // constant in (1) as key
    // (4) create a HotKey object, the HotKeyAction that should be executed by
    // the HotKey and
    // add both to the HotKeyMan (example see: AusgabeView,
    // initHotKeysAndAddToHotkeyman)
    // (5) add a default value to bns.config; REMEMBER TO ADD THE PROPER
    // SUFFIX!!
    ...
    /**
     * String to display for the 'Enter' key that is used to activate the
     * Chatline; Reason: toString() didn't work for the first
     * implementation..TODO test if still necessary
     * */
    public static final String SHOW_CHATLINE_TEXT = "Enter";

    public static final String HOTKEY_SHOW_CHATLINE = "reservedKeyShowChat";

    private static HashSet<KeyStroke> reservedKeys;
    static {
        reservedKeys = new HashSet<KeyStroke>();
    ...
    // The following constants are used to get the key description from the
    ...
    public static final String[] HOTKEY_SHOW_FLAG_X = new String[] { HOTKEY_SHOW_FLAG1, HOTKEY_SHOW_FLAG2,
    ...
    public static final String[] GROUP_MESSAGES = { HOTKEY_MSG1, HOTKEY_MSG2, HOTKEY_MSG3, HOTKEY_MSG4, HOTKEY_MSG5 };

    public static final String[] GROUP_NOT_EDITABLE = new String[] { HOTKEY_SHOW_CHATLINE };

    public static final String[] GROUP_NORMAL = new String[] { HOTKEY_ZOOM_IN, HOTKEY_ZOOM_OUT,
            HOTKEY_TOGGLE_BOT_VISIBILITY, HOTKEY_SHOW_FLAG1, HOTKEY_SHOW_FLAG2, HOTKEY_SHOW_FLAG3, HOTKEY_SHOW_FLAG4,
            HOTKEY_SHOW_FLAG5, HOTKEY_SHOW_FLAG6, };
     ...
     * @param keyName
     *            the name of the key
     * @return the KeyStroke for the keycode that was saved for the keyname or
     *         NULL if no (parsable) keycode was found
     */
