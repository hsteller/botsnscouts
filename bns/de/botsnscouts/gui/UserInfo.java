...
public class UserInfo extends TJPanel {
    ...
    private ArrayList<JLabel> labels = new ArrayList<JLabel>(10);
    ...
    public UserInfo(JButton addToTheBottomIfNotNull) {
        ...
        // a little hack:
        // I didn't manage/really try to track down why sometimes the cards are
        // not shown to the player.
        // It often seems to happen if the "EmergencySubmitter" submitted the
        // last move instead of the
        // human player himself - but I didn't see the reason why that should
        // make a difference for the
        // displaying of the player's new cards in the next turn
        // So I decided to add this "emergency button" to this panel here (shown
    ...
    public void setInfo(String s) {
        ...
        while (st.hasMoreTokens()) {
            ...
            if ((subString.toString().length() + token.length()) > textWidth) {
                labels.get(index).setText(subString.toString());
