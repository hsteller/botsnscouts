...
public class View extends JFrame {
    ...
    private final static Category CAT = Category.getInstance(View.class);
    ...
    /**
     * Create hotkeys that will be enabled if this is a GUI of a participating
     * player. (Only players should be able to chat)
     */
    ...
    private void initPlayerOnlyHotKeys() {
        ...
        HotKey key = new HotKey(HotKeyConf.HOTKEY_SHOW_CHATLINE, KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, 0), showChat);
        ...
        for (int i = 0; i < chatMsgCount; i++) {
            ...
            ChatMessageEditor editPanel = ChatMessageEditor.createEditorForMessage(chatMessageName);
    ...
    synchronized private void initView() {
        ...
        this.addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent e) {
                if (ausgabeView != null) {
                    ausgabeView.quit(false, false); // will tell all the others
                                                    // to quit, using
