...
public class AnimationConfig {
    ...
    /**
     * Number of pixels a robot will be moved in a single animation step. Has to
     * be between 1 and scaledFieldSize => Number of steps a one-field-move is
     * drawn = scaledFieldSize/MOVE_ROB_ANIMATION_OFFSET
     */
    private int animationOffsetMoveRob = 1;

    /**
     * Amount of time (in ms) we wait after a single animation step of
     * (pixel-)length MOVE_ROB_ANIMATION_OFFSET.
     */
    ...
    /**
     * Number of ms we sleep between starting to play the laser sound and
     * starting to animate the shot
     */
    private int laserDelayBetweenStartOfSoundAndAnimation = 200;

    /**
     * Number of ms to wait between drawing of two single steps during a laser
     * shot animation
     */
    private int laserDelayPerAnimationStep = 10;

    /**
     * Number of ms to wait after the shot animation was drawn (to let the sound
     * catch up/ to create a delay between this shot and another following
     * animation.
     */
    ...
    /**
     * We will wait this long before starting the animation after a new card is
     * evaluated
     */
    ...
    /**
     * @param delayBetweenActions
     *            The delayBetweenActions to set.
     */
    ...
    // TODO shouldn't be static..maybe create a meta-object that contains the
    // config settings for the three different speed levels and this one boolean
