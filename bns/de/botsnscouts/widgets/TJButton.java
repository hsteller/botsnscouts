...
public class TJButton extends JButton {
    ...
    public static class ButtonUI extends javax.swing.plaf.metal.MetalButtonUI {
        ...
        public void update(Graphics g, JComponent c) {
            ...
            fillRect(g, col, in.left - 2, in.top - 2, c.getWidth() - in.left - in.right + 4, c.getHeight() - in.top
                            - in.bottom + 4);
    ...
    public TJButton(String title) {
        this(title, 24);
    }

    static ButtonUI bui = new ButtonUI();

    public TJButton(String title, int fontSize) {
        super(title);
        setUI(bui);
