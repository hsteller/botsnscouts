...
/** Eine Klasse mit mehr oder minder hilfreichen Methoden */
public class H {
    ...
    /**
     * Zentriert den String s auf einer 'laenge' langen Zeile, d.h. es wird die entsprechende Anzahl Spaces davorgesetzt.
     * 
     * @param s
     *            Der zu zentrierende String
     * @param laenge
     *            Die L&auml;nge der Zeile, auf der s zentriert werden soll
     ...
     * 
     * @param str
     *            Dieser String wird als Eingabeaufforderung ausgegeben(kein Doppelpunkt)
     */
    ...
    /**
     * Pseudo ClearScreen-Befehl f&uuml;r die Textconsole; Die Methode gibt 80 Leerzeilen aus
     */
    ...
    /**
     * Versucht, dass File 'foo' zu erzeugen. Eventuell fehlende Verzeichnisse werden (hoffentlich :-)) erzeugt.
     */
            ...
            try {
                ...
                try {
                    ...
                    out.close();
                                                    ...
                                                    * Wenn die kommt, wars wohl ein anderer Fehler oder ich habe einen Fall nicht beruecksichtigt.. BUG: ..zum Beispiel, dass jemandem die Permissons fehlen..
                                                    */
                    ioe3.printStackTrace();
                    throw new IOException(
                                    "... War erfolglos.\nIOException beim Erzeugen der nicht vorhandenen Datei \""
                                                    + foo.toString() + "\" aufgetreten: " + ioe3.getMessage());
    ...
    /**
     * Diese Methode Liest eine Integer-Zahl von der Standardeinfgabe; Diese muss gr&ouml;sser als a und kleiner als b sein.
     * 
     * @param str
     *            Dieser String wird als Eingabeaufforderung ausgegeben(kein Doppelpunkt)
     * @param a
     *            Nur gr&ouml;ssere Zahlen werden angenommen
     * @param b
     *            Nur kleinere Zahlen werden angenommen
     */
    ...
    /**
     * Diese Methode liest einen einzelnen Buchstaben von der Standardeingabe; wird mehr als ein Zeichen eingegeben, so wird der erste Buchstabe eingelesen und der Rest der Eingabe ignoriert.
     * 
     * @param str
     *            Dieser String wird als Eingabeaufforderung ausgegeben(kein Doppelpunkt)
     */
    ...
    /**
     * F&uuml;r Schreibfaule; Gibt s auf der Standardausgabe aus
     */
    ...
    /**
     * Ein altes &Uuml;berbleibsel; wird von den read-Funktionen benutzt.
     */
    ...
    /**
     * Diese Methode pr&uuml;ft, ob der String a lexikographisch kleiner ist als der String b.
     * 
    ...
    /**
     * Diese Methode pr&uuml;ft, ob der String a lexikographisch kleiner oder gleich dem String b ist.
     * 
