...
public class Bot {
    ...
    /**
     * Factory can clone, too. This should not be done, however. What's the point?
     */
    ...
    /**
     * Which direction the bot is facing. N = 0; O = 1; S = 2; W = 3;
     */
    ...
    /**
     * contains the cards of the locked registers. Invariant lockedRegisters[i] -> move[i]!=null
     */
    ...
    /**
     * @param Name
     *            of the player/robot. Not public _on_purpose_. Use Bot.getNewInstance() instead.
     */
     ...
     * 
     * @param The
     *            bot whose status is to be copied.
     */
    ...
    /**
     * Returns the number of cards the server should give to this robot.
     */
    ...
    /**
     * returns an array which hold a card at position i if register i is locked, null otherwise This method is to be eliminated!
     */
    ...
    /**
     * Checks whether two bots are at the same location. If both are in a pitch, they are never at the same position.
     */
     ...
     * 
     * @return the content for the message to notify clients about this change
     */
    public String[] unlockAllRegistersAndGetMessage() {
        ...
        if (lockCounter > 0) {
            // at least one register was unlocked
    ...
    /**
     * The bot is falling into a pitch. I.e. it looses one life, gets full damage temporatily and moves to the virtual possition (0,0).
     */
    ...
    /**
     * CAUTION: if you call this method..are you sure about whether you need (un)locking of registers, too?
     */
    ...
    /**
     * Sets the bot's damage to zero and UNLOCKS ALL REGISTERS.
     * 
     * @return whatever unlockAllRegistersAndGetMessage() returns
     * 
     */
    public String[] setReenterDamage() {
        setDamage(2);
        return unlockAllRegistersAndGetMessage();
    }
    ...
    /**
     * Register n wird gesperrt und mit Card k belegt. deprecated Eigentlich hat man die entsprechende Card ja bereits im letzten Zug drin!!!
     */
     ...
     * 
     * The bot gets only as many cards as it should, the array is filled with nulls at the end.
     */
    ...
    /**
     * Programm the register. This means: set "zug" according to the cards I have in "Karten" and the locked registers.
     * 
     * @param Array
     *            which tells how to program: Includes the index in "karten" of the card to be put in the register. The array is one shorter for each lockes register. Pre: register includes only values from 1 to deales cards+1.
     */
    ...
    public String toString() {
        ...
        s += "naechsteflagge: " + nextFlag + "; archiv (x,y): (" + archiveX + ", " + archiveY + "); leben: " + lives
                        + "; schaden: " + damage + "\n";
