...
public class Global {
    ...
    /**
     * schaltet den Verbose-Modus an und aus setVerbose(true); schaltet ihn an ratet selbst, wie er wieder ausgeht
     */
    ...
    public static <K,V> String mapToString (Map <K, V> map, char delimiter) {
        StringBuffer sb = new StringBuffer();
        if (map == null) {
            sb.append("<NULL>");
        }
        else {
            Iterator<K> keyIt = map.keySet().iterator();
            while (keyIt.hasNext()) {
                ...
                if (val == null) {
                    ...
                    if (val instanceof Collection) {
                        ...
                        valS = collectionToString(tmp, ';');
                    }
                    else {
                        valS = val.toString();
                    }

                sb.append('\"').append(key).append("\" -> \"").append(valS).append("\"").append(delimiter);
            }
        }
        return sb.toString();
    ...
    public static <E> String collectionToString(Collection<E> c, char delimiter) {
        StringBuffer sb = new StringBuffer();
        if (c == null) {
            sb.append("<NULL>");
        }
