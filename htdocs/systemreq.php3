...
as long as you meet the hardware requirements. 
<P>
<H2>Hardware:</H2>
...
you also need a Java Runtime Environment, version 1.2. 
<P>
There seem to be problems with JDK1.3. Sorry. We are working on it.<BR>
